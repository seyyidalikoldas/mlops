...
4. Click __"New Notebook"__ to create a new notebook.
...
2. Select a Namespace:
   ...
   `<img src="/docs/images/notebooks-namespace1.png" alt="Selecting a Kubeflow namespace" class="mt-3 mb-3 border border-info rounded">`
3. Click __"Notebooks"__ in the left-hand panel:

   `<img src="/docs/images/jupyterlink1.png" alt="Opening notebooks from the Kubeflow UI" class="mt-3 mb-3 border border-info rounded">`
4. Click __"New Notebook"__ on the __"Notebooks"__ page:

   `<img src="/docs/images/add-notebook-server1.png" alt="The Kubeflow notebook servers page" class="mt-3 mb-3 border border-info rounded">`
5. Enter a __"Name"__ for your notebook server.
   ...
   `<img src="/docs/images/new-notebook-server1.png" alt="Form for adding a Kubeflow notebook server" class="mt-3 mb-3 border border-info rounded">`
...
15. Click __"CONNECT"__ to view the web interface exposed by your notebook server.
    ...
    `<img src="/docs/images/notebook-servers1.png" alt="Opening notebooks from the Kubeflow UI" class="mt-3 mb-3 border border-info rounded">`
