...
| [jupyter-spark-minio]()                                                                                                                        | [`yalcinerbasi/kubeflow-notebook:v2.0`](https://hub.docker.com/layers/yalcinerbasi/kubeflow-notebook/v2.0/images/sha256-aa32b127509ca70bb4bad1f52ff07ce2084aa352774afce943b074a6c388e4c7?context=explore) | JupyterLab + Spark + Minio with proxy configuration                                                                                                                           |

### Image Dependency Chart

This flow-chart shows how our notebook container images depend on each other.

<img src="/docs/images/notebook-container-image-chart.png" alt="A flow-chart showing how notebook container images depend on each other" class="mt-3 mb-3 border border-info rounded">
