+++
title = "Installing Oreflow"
description = "Deployment options for Oreflow"
weight = 20

+++

Oreflow is an end-to-end Machine Learning (ML) platform for Kubernetes, it provides components for each stage in the ML lifecycle, from exploration through to training and deployment.
Operators can choose what is best for their users, there is no requirement to deploy every component.
To read more about the components and architecture of Oreflow, please see the <a href="/docs/started/architecture/">Oreflow Architecture</a> page.

There are two pathways to get up and running with Oreflow, you may either:
1. Use a [packaged distribution](#packaged-distributions)
1. Use the [manifests](#manifests) (advanced)

<a id="packaged-distributions"></a>
## Install a packaged Oreflow distribution

{{% alert color="warning" %}}
Packaged distributions are developed and supported by their respective maintainers, the Oreflow community does not currently endorse or certify any distribution.
{{% /alert %}}
...
<div class="table-responsive">
  <table class="table table-bordered">
    ...
    <tbody>
      ...
      <tr>
        <td>Arrikto Oreflow as a Service</td>
        <td>Arrikto</td>
        <td>Fully Managed</td>
        <td>1.4</td>
        <td>N/A</td>
      ...
      <tr>
        <td>Arrikto Enterprise Oreflow</td>
        <td>Arrikto</td>
        <td>EKS,
            AKS,
            GKE
...
<a id="manifests"></a>
## Install the Oreflow Manifests manually

{{% alert color="warning" %}}
This method is for advanced users. The Oreflow community will not support environment-specific issues. If you need support, please consider using a [packaged distribution](#packaged-distributions) of Oreflow.
{{% /alert %}}

The <a href="https://github.com/kubeflow/community/tree/master/wg-manifests">Manifests Working Group</a> is responsible for aggregating the authoritative manifests of each official Oreflow component.
...
* Review the Oreflow <a href="/docs/components/">component documentation</a>
* Explore the <a href="/docs/components/pipelines/sdk/">Oreflow Pipelines SDK</a>
