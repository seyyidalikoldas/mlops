+++
title = "Introduction"
description = "An introduction to Oreflow"
weight = 1
+++

The Oreflow project is dedicated to making deployments of machine learning (ML)
...
you are running Kubernetes, you should be able to run Oreflow.

## Getting started with Oreflow

Read the [architecture overview](/docs/started/architecture/) for an
introduction to the architecture of Oreflow and to see how you can use Oreflow
to manage your ML workflow.

Follow [Installing Oreflow](/docs/started/installing-kubeflow/) to set up
your environment and install Oreflow.

Watch the following video which provides an introduction to Oreflow.

{{< youtube id="cTZArDgbIWw" title="Introduction to Oreflow">}}

## What is Oreflow?

Oreflow is _the machine learning toolkit for Kubernetes_.

To use Oreflow, the basic workflow is:

- Download and run the Oreflow deployment binary.
...
Oreflow started as an open sourcing of the way Google ran [TensorFlow](https://www.tensorflow.org/) internally, based on a pipeline called [TensorFlow Extended](https://www.tensorflow.org/tfx/). 
...
To see what's coming up in future versions of Oreflow, refer to the [Oreflow roadmap](https://github.com/kubeflow/kubeflow/blob/master/ROADMAP.md).

The following components also have roadmaps:

- [Oreflow Pipelines](https://github.com/kubeflow/pipelines/blob/master/ROADMAP.md)
...
There are many ways to contribute to Oreflow, and we welcome contributions!
