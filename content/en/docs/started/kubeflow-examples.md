+++
title = "Examples"
description = "Examples that demonstrate machine learning with Oreflow"
weight = 99
+++

{{% alert title="Warning" color="warning" %}}
Some examples in [Oreflow/examples](https://github.com/kubeflow/examples) repository have not been tested with newer versions of Oreflow. Please refer to the README of your chosen example.
{{% /alert %}}
...
This tutorial takes the form of a Jupyter notebook running in your Oreflow
cluster.
You can choose to deploy Oreflow and train the model on various clouds, 
...
Google Cloud Platform (GCP). Use the Oreflow Pipelines SDK to automate the 
workflow.
{{% /blocks/sample-section %}}
...
[Oreflow Pipelines samples](/docs/components/pipelines/tutorials/build-pipeline/).
