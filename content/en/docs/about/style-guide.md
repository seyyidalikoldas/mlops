...
description = "Style guide for writing Oreflow documentation"
weight = 90
+++

This style guide is for the [Oreflow documentation](/docs/).
The style guide helps contributors to write documentation that readers can understand quickly and correctly.

The Oreflow docs aim for:
...
- In page content, use capitals only for brand names, like Oreflow, Kubernetes, and so on.
...
Do not use abbreviations even if they're in common use, unless the product owner has sanctioned the abbreviation.`<div class="table-responsive">`
...
- Most pages in the Oreflow docs use a period at the end of every list item.
...
<div class="table-responsive">
  <table class="table table-bordered">
    ...
    <tbody>
      <tr>
        <td>You can configure Oreflow to</td>
        <td>Oreflow can be configured to</td>
      </tr>
      <tr>
...
- `export OREFLOW_USERNAME=<your username>`
- `--email <your email address>`

## Style your images

The Oreflow docs recognise Bootstrap classes to style images and other content.
...
- Take a look at the [documentation README](https://github.com/kubeflow/website/blob/master/README.md) for guidance on contributing to the Oreflow docs.
